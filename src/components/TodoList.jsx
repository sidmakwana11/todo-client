...
function SortableTodoItem({ task, deleteTask, fetchTasks, navigateToCropper }) {
...
function TodoList() {
    ...
    const handleDragEnd = (event) => {
        ...
        if (over && active.id !== over.id) {
            ...
            // You might want to send an API request here to update the order in your database
            console.log("Task reordered:", active.id, "moved to", over.id);
        }
    };
